 ...
 *
 */
public abstract class BaseUnispectSpectrumTypePeer
    extends BasePeer
{
    /** Serial version */
     ...
     * @deprecated Torque.getMapBuilder(UnispectSpectrumTypeMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(UnispectSpectrumTypeMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the ONTOLOGY_LINK field */
    public static final String ONTOLOGY_LINK;
    /** the column name for the ONTOLOGY_TERM field */
    public static final String ONTOLOGY_TERM;

    static
    {
        DATABASE_NAME = "unispect";
        TABLE_NAME = "SPECTRUM_TYPE";

        SPECTRUM_TYPE_ID = "SPECTRUM_TYPE.SPECTRUM_TYPE_ID";
        NAME = "SPECTRUM_TYPE.NAME";
        ONTOLOGY_LINK = "SPECTRUM_TYPE.ONTOLOGY_LINK";
        ONTOLOGY_TERM = "SPECTRUM_TYPE.ONTOLOGY_TERM";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(UnispectSpectrumTypeMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(UnispectSpectrumTypeMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "ee.ut.cs.unispect.om.UnispectSpectrumType";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<UnispectSpectrumType> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static ObjectKey doInsert(Criteria criteria)
        throws TorqueException
    {
        return BaseUnispectSpectrumTypePeer
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(ONTOLOGY_LINK);
        criteria.addSelectColumn(ONTOLOGY_TERM);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static UnispectSpectrumType row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            UnispectSpectrumType obj = (UnispectSpectrumType) cls.newInstance();
            UnispectSpectrumTypePeer.populateObject(row, offset, obj);
    ...
    public static void populateObject(Record row,
                                      int offset,
                                      UnispectSpectrumType obj)
        throws TorqueException
    {
        try
        {
            obj.setSpectrumTypeId(row.getValue(offset + 0).asInt());
            obj.setName(row.getValue(offset + 1).asString());
            obj.setOntologyLink(row.getValue(offset + 2).asString());
            obj.setOntologyTerm(row.getValue(offset + 3).asString());
        }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<UnispectSpectrumType> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<UnispectSpectrumType> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<UnispectSpectrumType> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<UnispectSpectrumType> results = new ArrayList<UnispectSpectrumType>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(UnispectSpectrumTypePeer.row2Object(row, 1,
                UnispectSpectrumTypePeer.getOMClass()));
        }
        return results;
    }
        ...
        throws TorqueException
    {
        ...
        correctBooleans(criteria);
         ...
         selectCriteria.put(SPECTRUM_TYPE_ID, criteria.remove(SPECTRUM_TYPE_ID));
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<UnispectSpectrumType> doSelect(UnispectSpectrumType obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(UnispectSpectrumType obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(UnispectSpectrumType obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(UnispectSpectrumType obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(UnispectSpectrumType) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(UnispectSpectrumType obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(UnispectSpectrumType) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(UnispectSpectrumType obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(UnispectSpectrumType) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(UnispectSpectrumType obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( ObjectKey pk )
    {
        Criteria criteria = new Criteria();
            criteria.add(SPECTRUM_TYPE_ID, pk);
        return criteria;
     }

    /** Build a Criteria object from the data object for this peer */
    public static Criteria buildCriteria( UnispectSpectrumType obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(SPECTRUM_TYPE_ID, obj.getSpectrumTypeId());
        criteria.add(NAME, obj.getName());
        criteria.add(ONTOLOGY_LINK, obj.getOntologyLink());
        criteria.add(ONTOLOGY_TERM, obj.getOntologyTerm());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( UnispectSpectrumType obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static UnispectSpectrumType retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static UnispectSpectrumType retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static UnispectSpectrumType retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        UnispectSpectrumType retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static UnispectSpectrumType retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<UnispectSpectrumType> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
        ...
        {
            return (UnispectSpectrumType)v.get(0);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<UnispectSpectrumType> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<UnispectSpectrumType> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<UnispectSpectrumType> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<UnispectSpectrumType> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<UnispectSpectrumType>();
        }
        else
        {
            Criteria criteria = new Criteria();
            criteria.addIn( SPECTRUM_TYPE_ID, pks );
