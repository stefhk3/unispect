 ...
 *
 */
public abstract class BaseUnispectCompoundPeer
    extends BasePeer
{
    /** Serial version */
     ...
     * @deprecated Torque.getMapBuilder(UnispectCompoundMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(UnispectCompoundMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the INCHI_KEY field */
    public static final String INCHI_KEY;
    /** the column name for the INCHI field */
    ...
    static
    {
        ...
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(UnispectCompoundMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(UnispectCompoundMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "ee.ut.cs.unispect.om.UnispectCompound";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<UnispectCompound> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static ObjectKey doInsert(Criteria criteria)
        throws TorqueException
    {
        return BaseUnispectCompoundPeer
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(INCHI_KEY);
        criteria.addSelectColumn(INCHI);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static UnispectCompound row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            UnispectCompound obj = (UnispectCompound) cls.newInstance();
            UnispectCompoundPeer.populateObject(row, offset, obj);
    ...
    public static void populateObject(Record row,
                                      int offset,
                                      UnispectCompound obj)
        throws TorqueException
    {
        try
        {
            obj.setCompoundId(row.getValue(offset + 0).asInt());
            obj.setDate(row.getValue(offset + 1).asUtilDate());
            obj.setInchiKey(row.getValue(offset + 2).asString());
            obj.setInchi(row.getValue(offset + 3).asString());
        }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<UnispectCompound> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<UnispectCompound> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<UnispectCompound> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<UnispectCompound> results = new ArrayList<UnispectCompound>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(UnispectCompoundPeer.row2Object(row, 1,
                UnispectCompoundPeer.getOMClass()));
        }
        return results;
    }
        ...
        throws TorqueException
    {
        ...
        correctBooleans(criteria);
         ...
         selectCriteria.put(COMPOUND_ID, criteria.remove(COMPOUND_ID));
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<UnispectCompound> doSelect(UnispectCompound obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(UnispectCompound obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(UnispectCompound obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(UnispectCompound obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(UnispectCompound) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(UnispectCompound obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(UnispectCompound) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(UnispectCompound obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(UnispectCompound) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(UnispectCompound obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( ObjectKey pk )
    {
        Criteria criteria = new Criteria();
            criteria.add(COMPOUND_ID, pk);
        return criteria;
     }

    /** Build a Criteria object from the data object for this peer */
    public static Criteria buildCriteria( UnispectCompound obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(COMPOUND_ID, obj.getCompoundId());
        criteria.add(DATE, obj.getDate());
        criteria.add(INCHI_KEY, obj.getInchiKey());
        criteria.add(INCHI, obj.getInchi());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( UnispectCompound obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static UnispectCompound retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static UnispectCompound retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static UnispectCompound retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        UnispectCompound retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static UnispectCompound retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<UnispectCompound> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
        ...
        {
            return (UnispectCompound)v.get(0);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<UnispectCompound> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<UnispectCompound> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<UnispectCompound> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<UnispectCompound> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<UnispectCompound>();
        }
        else
        {
            Criteria criteria = new Criteria();
            criteria.addIn( COMPOUND_ID, pks );
